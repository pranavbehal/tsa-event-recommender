...
export default function Quiz() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-semibold text-center mb-6">{currentQ.question}</h2>
        ...
        >
          <RadioGroup onValueChange={handleAnswer} className="space-y-3">
            {currentQ.options.map((option) => (
              <div key={option.value} className="flex items-center space-x-2 p-3 rounded-lg hover:bg-accent transition-colors">
